...
cConstant (Str x) = "(Value*)idris2_makeString(\{show $ length x}, \{cStringQuoted x})"
...
cOp StrLength     [x]       = "idris2_stringLength(" ++ x ++ ")"
cOp StrHead       [x]       = "idris2_stringHead(" ++ x ++ ")"
cOp StrTail       [x]       = "idris2_stringTail(" ++ x ++ ")"
cOp StrReverse    [x]       = "idris2_stringReverse(" ++ x ++ ")"
...
cOp StrIndex      [x, i]    = "idris2_stringIndex(" ++ x ++ ", " ++ i ++ ")"
cOp StrCons       [x, y]    = "idris2_stringCons(" ++ x ++ ", " ++ y ++ ")"
cOp StrAppend     [x, y]    = "idris2_stringAppend(" ++ x ++ ", " ++ y ++ ")"
cOp StrSubstr     [x, y, z] =  "idris2_stringSubstr(" ++ x ++ ", " ++ y  ++ ", " ++ z ++ ")"
...
packCFType CFString        varName = "idris2_makeStringFromCString(" ++ varName ++ ")"
